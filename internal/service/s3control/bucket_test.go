...
import (
	...
	tfs3control "terraform-provider-awsgps/internal/service/s3control"
...
func TestAccS3ControlBucket_tags(t *testing.T) {
	acctest.Skip(t, "S3 Control Bucket resource tagging requires additional eventual consistency handling, see also: https://terraform-provider-awsgps/issues/15572")
	ctx := acctest.Context(t)
